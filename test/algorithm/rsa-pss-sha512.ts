    ...
    describe('specification examples', () => {
        ...
        describe('minimal example', () => {
            ...
            it('successfully verifies a signature', async () => {
                const sig = Buffer.from('HWP69ZNiom9Obu1KIdqPPcu/C1a5ZUMBbqS/xwJECV8bhIQVmE' +
        ...
        describe('selective example', () => {
            ...
            it('successfully verifies a signature', async () => {
                const sig = Buffer.from('ik+OtGmM/kFqENDf9Plm8AmPtqtC7C9a+zYSaxr58b/E6h81gh' +
        ...
        describe('full example', () => {
            ...
            it('successfully verifies a signature', async () => {
                const sig = Buffer.from('JuJnJMFGD4HMysAGsfOY6N5ZTZUknsQUdClNG51VezDgPUOW03' +
